    ...
    <section id="about" className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative bg-card/50 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-soft border border-border/50 mb-12 animate-slide-up hover:shadow-glow transition-smooth">
            <div className="absolute -top-4 -left-4 w-20 h-20 gradient-primary rounded-2xl flex items-center justify-center rotate-12 shadow-glow">
            ...
            <div className="mt-8 h-1 w-full bg-gradient-to-r from-transparent via-primary to-transparent rounded-full"></div>
          </div>

          {/* Traits Grid with Enhanced Cards */}
          <div className="grid md:grid-cols-2 gap-6">
            {traits.map((trait, index) => (
              <div
                key={trait.title}
                className="group relative bg-card/50 backdrop-blur-sm rounded-2xl p-6 shadow-soft hover:shadow-glow transition-smooth hover:-translate-y-2 animate-slide-up border border-border/50 overflow-hidden"
              ...
              >
                ...
                <div className="relative z-10">
                  <div className={`w-14 h-14 bg-gradient-to-br ${trait.gradient} rounded-xl flex items-center justify-center mb-4 shadow-soft group-hover:scale-110 group-hover:rotate-3 transition-smooth`}>
                    <trait.icon className="text-white" size={24} />
                  </div>
                  <h3 className="text-xl font-semibold mb-2 group-hover:text-primary transition-smooth">{trait.title}</h3>
                  <p className="text-muted-foreground leading-relaxed">{trait.description}</p>
                </div>

                {/* Corner Decoration */}
                <div className="absolute -bottom-2 -right-2 w-16 h-16 bg-primary/5 rounded-full blur-xl group-hover:bg-primary/10 transition-smooth"></div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-16 relative">
            <div className="bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 rounded-3xl p-8 md:p-12 backdrop-blur-sm border border-border/50 shadow-soft">
              <div className="text-center relative">
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 gradient-secondary rounded-full flex items-center justify-center shadow-glow">
                  <Sparkles className="text-white animate-pulse" size={24} />
                </div>
                <blockquote className="text-xl md:text-2xl font-light italic text-foreground pt-4">
